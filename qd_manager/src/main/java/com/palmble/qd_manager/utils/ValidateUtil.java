...
public class ValidateUtil {
	 ...
	 * @date 2018年6月13日
	 */
	public static String CardNoValidate(String IDStr) {
    ...
    /**
     * <p>Title: 验证生日与身份证出生日期是否一致</p>   
     * @author WangYanke  
     * @return boolean
     * @date 2018年6月13日
     */
    public static  boolean validateBirthdayOrCardNo(String birthDay,String cardNo) {
    	boolean flag=false;
    	String cardBirthDay = cardNo.substring(6, 14);
    	if(cardBirthDay.equals(birthDay)) {
    		flag=true;
    	}else {
    		flag=false;
    	}
